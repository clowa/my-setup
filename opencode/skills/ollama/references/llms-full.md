...
1. Confirm Base URL is set to `http://localhost:11434` and click **Save**
...
1. Select the model drowpdown > **Manage models**
...
1. Enter **Ollama** under **Provider Dropdown** and select desired models (e.g `qwen3, qwen3-coder:480b-cloud`)
